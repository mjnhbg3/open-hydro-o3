...
class SensorInterface:
    ...
    def _mock_sensor_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "root": {
                "temperature": round(21 + random.gauss(0, 0.5), 1)
            },
            "light": {
    ...
    async def calibrate_sensor(self, sensor: str, calibration_data: Dict[str, float]) -> bool:
